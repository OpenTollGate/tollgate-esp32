...
You are the isolated manager of balloon-pow only. You report to the balloon-hermes orchestrator group.
...
- Your status file: docs/STATUS-balloon-pow.md in this worktree
