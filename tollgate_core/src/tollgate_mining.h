...
#define TG_MINING_SHARE_WINDOW_S 30
#define TG_MINING_BLOCK_SUBSIDY_SATS 312500000ULL
#define TG_MINING_BLOCKS_PER_DAY 144ULL
#define TG_MINING_MAX_CLIENTS 10
...
uint64_t tg_mining_shares_to_allotment_ms(double hashrate_ghs, double hashprice, int price, int step_ms);
uint64_t tg_mining_shares_to_allotment_bytes(double hashrate_ghs, double hashprice, int price, int step_bytes);
